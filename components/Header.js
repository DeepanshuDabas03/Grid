      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-5 w-auto" src="/flipkart.svg/" alt="" />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-black shadow-lg ring-1 ring-white-900/5">
                <div className="p-4">
                  {products.map((item) => (
                    <div
                      key={item.name}
                ...
                <div className="grid grid-cols-2 divide-x divide-white-900/5 bg-white-50">
                  {callsToAction.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-white-900 hover:bg-white-100"
                    >
                      <item.icon className="h-5 w-5 flex-none text-white-400" aria-hidden="true" />
                      {item.name}
                    </a>
                  ))}
                </div>
